// src/components/HoshinKanri/PADigitiseArchive.jsx
...
const PADigitiseArchive = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["pa-digitise-archive"];
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: Priorities and activities digitise the archives</h4>
...
export default PADigitiseArchive;