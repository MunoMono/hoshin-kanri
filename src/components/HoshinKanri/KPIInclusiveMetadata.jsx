// src/components/HoshinKanri/KPIInclusiveMetadata.jsx
...
const KPIInclusiveMetadata = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["kpi-inclusive-metadata"];
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: Kpi Inclusive Metadata</h4>
...
export default KPIInclusiveMetadata;