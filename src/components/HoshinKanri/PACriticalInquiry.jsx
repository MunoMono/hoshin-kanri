// src/components/HoshinKanri/PACriticalInquiry.jsx
...
const PACriticalInquiry = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["pa-critical-inquiry"];
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: Priorities and activities critical inquiry</h4>
...
export default PACriticalInquiry;