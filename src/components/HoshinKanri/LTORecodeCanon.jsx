// src/components/HoshinKanri/LTORecodeCanon.jsx
...
const LTORecodeCanon = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["lto-recode-canon"];
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: Long-term objectives recode the canon</h4>
