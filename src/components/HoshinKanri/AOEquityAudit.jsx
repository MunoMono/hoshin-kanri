// src/components/HoshinKanri/AOEquityAudit.jsx
...
const AOEquityAudit = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["ao-equity-audit"];

  const CARD_CHAIN = [
    "longtermobjective5",
    "prioritiesandactivities2",
    "ao12", // ✅ Canonical ID for AO1.2
    "kpi4",
    "kpi6"
  ];
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: Yr 1 annual objective – equity audit</h4>
