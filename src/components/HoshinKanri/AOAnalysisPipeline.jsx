// src/components/HoshinKanri/AOAnalysisPipeline.jsx
...
const AOAnalysisPipeline = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["ao-analysis-pipeline"];
  ...
  return (
    <>
      <h4 className="filter-heading">
        Filter: Yr 1 annual objective – analysis pipeline
      </h4>
...
export default AOAnalysisPipeline;