// src/components/HoshinKanri/AOPrototypeTaxonomy.jsx
...
const AOPrototypeTaxonomy = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["ao-prototype-taxonomy"];
  ...
  const CARD_CHAIN = [
    ...
    "ao16", // ✅ Corrected canonical ID for AO1.6
    "kpi1",
    "kpi3",
    "kpi4",
    "kpi5",
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: Yr 1 annual objective – taxonomy prototyping</h4>
...
export default AOPrototypeTaxonomy;