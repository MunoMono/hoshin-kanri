// src/components/HoshinKanri/KPIInterviews.jsx
...
const KPIInterviews = ({ data, renderInlineTargets }) => {
  const description = data.use_cases?.["kpi-interviews"];
  ...
  return (
    <>
      <h4 className="filter-heading">Filter: KPI interviews</h4>
